...
numClavos([Color1|Resto],C):-igualdad(Color1,b),suma(C,0,0),numClavos(Resto,C).
numClavos([Color1|Resto],C):-igualdad(Color1,a),suma(C,0,s(G)),numClavos(Resto,G).
numClavos([Color1|Resto],C):-igualdad(Color1,am),suma(C,0,s(G)),numClavos(Resto,G).
numClavos([Color1|Resto],C):-igualdad(Color1,r),suma(C,0,s(G)),numClavos(Resto,G).
numClavos([Color1|Resto],C):-igualdad(Color1,v),suma(C,0,s(G)),numClavos(Resto,G).
